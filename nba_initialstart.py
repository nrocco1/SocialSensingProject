# this file will be run initially to create the scores dict. after this is run at the beginning of each day, the program nba_continue.py will be run continuously next to continue gathering tweets.
